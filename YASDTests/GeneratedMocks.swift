// MARK: - Mocks generated from file: YASD/Model/FormattedWord.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Model/Lexin/LexinWord.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Model/ParametersStorage.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Model/SettingsItem.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Model/Suggestion.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/DataCache.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/HtmlParser.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/Markdown.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/Network.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/Player.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Platform/Storage.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/CacheService.swift at 2019-12-21 11:36:32 +0000
...
import RxSwift
 ...
 class MockCacheService: CacheService, Cuckoo.ClassMock {
    ...
    private var __defaultImplStub: CacheService?
     ...
     override func run(_ action: @escaping CachableAction, forKey key: String) -> Observable<Data> {
        
    return cuckoo_manager.call("run(_: @escaping CachableAction, forKey: String) -> Observable<Data>",
	 ...
	 struct __StubbingProxy_CacheService: Cuckoo.StubbingProxy {
	    ...
	    func run<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ action: M1, forKey key: M2) -> Cuckoo.ClassStubFunction<(CachableAction, String), Observable<Data>> where M1.MatchedType == CachableAction, M2.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(CachableAction, String)>] = [wrap(matchable: action) { $0.0 }, wrap(matchable: key) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockCacheService.self, method: "run(_: @escaping CachableAction, forKey: String) -> Observable<Data>", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_CacheService: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func run<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(_ action: M1, forKey key: M2) -> Cuckoo.__DoNotUse<(CachableAction, String), Observable<Data>> where M1.MatchedType == CachableAction, M2.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(CachableAction, String)>] = [wrap(matchable: action) { $0.0 }, wrap(matchable: key) { $0.1 }]
	        return cuckoo_manager.verify("run(_: @escaping CachableAction, forKey: String) -> Observable<Data>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
...
// MARK: - Mocks generated from file: YASD/Service/HistoryService.swift at 2019-12-21 11:36:32 +0000
...
import RxSwift
 ...
 class MockHistoryService: HistoryService, Cuckoo.ClassMock {
    
     typealias MocksType = HistoryService
    
     typealias Stubbing = __StubbingProxy_HistoryService
     typealias Verification = __VerificationProxy_HistoryService

     let cuckoo_manager = Cuckoo.MockManager.preconfiguredManager ?? Cuckoo.MockManager(hasParent: true)

    
    private var __defaultImplStub: HistoryService?

     func enableDefaultImplementation(_ stub: HistoryService) {
        __defaultImplStub = stub
        cuckoo_manager.enableDefaultStubImplementation()
    }
    ...
    return cuckoo_manager.call("get(with: String) -> Observable<SuggestionResult>",
            parameters: (word),
            ...
            superclassCall:
                ...
                super.get(with: word)
                ,
            defaultCall: __defaultImplStub!.get(with: word))
    ...
    return cuckoo_manager.call("add(_: String) -> Observable<Void>",
            parameters: (word),
            escapingParameters: (word),
            superclassCall:
    ...
    return cuckoo_manager.call("remove(_: String) -> Observable<Void>",
            parameters: (word),
            escapingParameters: (word),
            superclassCall:
	 ...
	 struct __StubbingProxy_HistoryService: Cuckoo.StubbingProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
	    ...
	    func get<M1: Cuckoo.Matchable>(with word: M1) -> Cuckoo.ClassStubFunction<(String), Observable<SuggestionResult>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockHistoryService.self, method: "get(with: String) -> Observable<SuggestionResult>", parameterMatchers: matchers))
	    }
	    
	    func add<M1: Cuckoo.Matchable>(_ word: M1) -> Cuckoo.ClassStubFunction<(String), Observable<Void>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockHistoryService.self, method: "add(_: String) -> Observable<Void>", parameterMatchers: matchers))
	    }
	    
	    func remove<M1: Cuckoo.Matchable>(_ word: M1) -> Cuckoo.ClassStubFunction<(String), Observable<Void>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockHistoryService.self, method: "remove(_: String) -> Observable<Void>", parameterMatchers: matchers))
	    }
	    
	}

	 struct __VerificationProxy_HistoryService: Cuckoo.VerificationProxy {
	    private let cuckoo_manager: Cuckoo.MockManager
	    private let callMatcher: Cuckoo.CallMatcher
	    private let sourceLocation: Cuckoo.SourceLocation
	    ...
	    @discardableResult
	    func get<M1: Cuckoo.Matchable>(with word: M1) -> Cuckoo.__DoNotUse<(String), Observable<SuggestionResult>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return cuckoo_manager.verify("get(with: String) -> Observable<SuggestionResult>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func add<M1: Cuckoo.Matchable>(_ word: M1) -> Cuckoo.__DoNotUse<(String), Observable<Void>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return cuckoo_manager.verify("add(_: String) -> Observable<Void>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func remove<M1: Cuckoo.Matchable>(_ word: M1) -> Cuckoo.__DoNotUse<(String), Observable<Void>> where M1.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String)>] = [wrap(matchable: word) { $0 }]
	        return cuckoo_manager.verify("remove(_: String) -> Observable<Void>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	}
}

 class HistoryServiceStub: HistoryService {
...
// MARK: - Mocks generated from file: YASD/Service/LexinApi/LexinApi.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/LexinApi/LexinApiProvider.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/LexinParser/LexinParserSuggestion.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/LexinParser/LexinParserWords.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/LexinService/LexinService.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/LexinService/LexinServiceFormatter.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/NetworkService.swift at 2019-12-21 11:36:32 +0000
...
// MARK: - Mocks generated from file: YASD/Service/PlayerService.swift at 2019-12-21 11:36:32 +0000
