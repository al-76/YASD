...
struct FormattedWord: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard let attributedString = try NSKeyedUnarchiver
                .unarchiveTopLevelObjectWithData(container.decode(Data.self,
                                                                  forKey: .formatted)) as? NSAttributedString else {
            throw DecodingError.dataCorruptedError(forKey: .formatted,
                                                   in: container,
                                                   debugDescription: "Data is corrupted")
        }
        header = try container.decode(String.self, forKey: .header)
        formatted = attributedString
        soundUrl = try container.decode(String.self, forKey: .soundUrl)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(NSKeyedArchiver.archivedData(withRootObject: formatted,
...
extension FormattedWord: Equatable {
    public static func == (lhs: FormattedWord, rhs: FormattedWord) -> Bool {
