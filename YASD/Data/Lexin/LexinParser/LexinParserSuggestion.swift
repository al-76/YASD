...
class LexinParserSuggestionDefault: LexinParserSuggestion {
    ...
    private func getRequestparameters(_ word: String, _ language: String) -> (String?, [String: String]?) {
        let body = "7|0|8|" + LexinParserSuggestionDefault.url +
            "|CA6A42B3B5F751C0CF9E859210723485|" +
            "se.jojoman.lexin.lexingwt.client.CompletionService|" +
            "getSuggestions|se.jojoman.lexin.lexingwt.client.CompletionRequest/881062947|" + language +
            "|com.google.gwt.user.client.ui.SuggestOracle$Request/3707347745|" + word.lowercased() +
            "|1|2|3|4|1|5|5|6|0|7|5|8|"
...
class LexinParserSuggestionFolkets: LexinParserSuggestion {
    ...
    private func getRequestparameters(_ word: String, _: String) -> (String?, [String: String]?) {
        let body = "7|0|7|" + LexinParserSuggestionFolkets.url +
            "|72408650102EFF3C0092D16FF6C6E52F|" +
            "se.algoritmica.folkets.client.ItemSuggestService|" +
            "getSuggestions|se.algoritmica.folkets.client.ProposalRequest/3613917143|" +
            "com.google.gwt.user.client.ui.SuggestOracle$Request/3707347745|" + word.lowercased() +
            "|1|2|3|4|1|5|5|0|6|5|7|"
